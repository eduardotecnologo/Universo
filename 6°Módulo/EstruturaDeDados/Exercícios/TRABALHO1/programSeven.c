// 7. Escreva um algoritmo que leia dois vetores de 10 posições e faça a multiplicação dos
...
int main (){
    ...
    for(i = 0;i < 10;i++){
        ...
        printf("Insira o %d o elemento do vetor 2: ", (i + 1));
        scanf("%d", &vet_b[i]);
    }for(i = 0; i < 10; i++){
        vet_c[i] = vet_a[i] * vet_b[i];
        printf("%d O elemento do vetor resultante\n: %d", (i + 1), vet_c[i]);
    }
    return 0;
}
